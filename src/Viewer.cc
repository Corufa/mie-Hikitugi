...
void Viewer::Run()
{
    ...
    pangolin::Var<float> menuPointsSize("menu.Points Size", 1.6, 1e-1, 1e1, true);
    pangolin::Var<float> menuObjectsPointsSize("menu.Obj-Points Size", 6.0, 1e-1, 1e1, true);
    ...
    pangolin::Var<bool> menu3DBbox("menu.Disp 3D Bboxes", true, true);
